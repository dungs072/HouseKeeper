namespace HouseKeeper.Configs
{
    public class CreateAccountConfig
    {
        ...
        public static string ServerError = "Server error, try again!";
        public static string FrontImageError = "Front image error!";
        public static string BackImageError = "Back image error!";
        public static string AvatarImageError = "Avatar image error!";
