...
namespace HouseKeeper.Respositories
{
    public interface IAdminRespository
    {
        ...
        // PaidType
        Task<List<HINHTHUCTRALUONG>> GetPaidTypes(string search="");
        ...
        //Experience
        Task<List<KINHNGHIEM>> GetExperiences(string search="");
        ...
        //Rejection
        Task<List<LYDOTUCHOI>> GetRejections(string search="");
        ...
        //Price packet
        Task<List<GOITIN>> GetPricePackets(string search = "");
